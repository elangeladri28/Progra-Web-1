 ...
 * @author adria
 */
@WebServlet(name = "NoticiasFavoritas", urlPatterns = {"/NoticiasFavoritas"})
public class NoticiasFavoritas extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            List<AgregarNoticiaModel> favs = AddNoticiaDAO.NoticiasFavs();
            request.setAttribute("favoritas", favs);
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (respuestita.equals("Rechazado") == true) {
            ...
            try {
                ...
                Logger.getLogger(NoticiasFavoritas.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            ...
            try {
                AddNoticiaDAO.NoticiasFavoritas(newNews);
            } catch (SQLException ex) {
                Logger.getLogger(NoticiasFavoritas.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
