...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
    <link rel="stylesheet" href="assets/css/modschetas.css" />
</head>
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light shadow p-2 mb-4" style="background-color: #ffb84d;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <!-- <li class="nav-item">
                <a class="nav-link" href="Login.html">Juegos de pelota</a>
            </li> -->
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="#">Futbol Soccer</a>
                        ...
                        <a class="dropdown-item" href="#">Mas deportes...</a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="#">Esgrima</a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Todos los Deportes</a>
                </li>
            </ul>
            ...
            <form class="form-inline my-2 my-lg-0">
                ...
                <a href="Register.html" class="btn btn-info" role="button"
