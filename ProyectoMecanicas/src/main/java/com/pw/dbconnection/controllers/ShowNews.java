...
public class ShowNews extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        AgregarNoticiaModel ANM = AddNoticiaDAO.NoticiaEspecifica(Integer.parseInt(idNews, 10));
        request.setAttribute("New", ANM);
        
        List<ComentarioModel> commentaries = CommentsDAO.getCommentsByNews(Integer.parseInt(idNews,10));
        request.setAttribute("Commentaries",commentaries);
        request.getRequestDispatcher("ViendoNoticia.jsp").forward(request, response);
    }
