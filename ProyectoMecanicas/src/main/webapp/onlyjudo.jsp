...
<%
    ...
    List<AgregarNoticiaModel> Noticion = (List<AgregarNoticiaModel>) request.getAttribute("NoticiaChetada");
%>
<!DOCTYPE html>
<html lang="en">
    ...
    <head>
        ...
        crossorigin="anonymous"></script>
        <link rel="stylesheet" href="assets/css/modsjudo.css" />
    </head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <%if(Noticias.getSport().equals("Judo")){%>
