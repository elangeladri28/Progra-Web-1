            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="SoccerNews">Futbol Soccer</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="MostrarNoticias">Judo</a>
                        </div>
                    </li>
                    ...
                    <%}%>
                    <%if (Tipo.equals("Administrador") || Tipo.equals("Editor") || Tipo.equals("Creador") || Tipo.equals("Lector")) {%>

                    <li class="nav-item">
                        <a class="nav-link" href="NoticiasFavoritas">Favoritas</a>
                    </li>
                ...
                <form class="form-inline my-2 my-lg-0">
                    ...
                    <div class="media" style="margin-left: 10px;">
                        <img href="Images/<%=(String) session.getAttribute("Image")%>"  width="30" height="30" class="mr-3" alt="...">
                    </div>
