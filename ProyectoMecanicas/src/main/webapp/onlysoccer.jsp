<%-- 
    Document   : onlysoccer
    Created on : Dec 7, 2020, 2:02:34 AM
    Author     : adria
--%>
...
<%
    ...
    List<AgregarNoticiaModel> Noticion = (List<AgregarNoticiaModel>) request.getAttribute("NoticiasSoccer");
%>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
    <link rel="stylesheet" href="assets/css/modssoccer.css" />
</head>
...
<body>
   <nav class="navbar sticky-top navbar-expand-lg navbar-light shadow p-2 mb-4" style="background-color: #ffb84d;">
    ...
    <div class="container">
         <%
                for (AgregarNoticiaModel Noticias : Noticion) {
            %>

            <%if(Noticias.getSport().equals("Futbol Soccer")){%>
            <div  style="margin-bottom: 10px;">
                <a href="ShowNews?id=<%= Noticias.getID() %>" style="text-decoration: none; color: rgb(80, 48, 48) ;">

                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="Images/<%=Noticias.getImg1()%>" class="card-img" >
                            </div>
                            <div class="col-md-8">
                                <Form action="">
                                    <div class="card-body">
                                        <h5 class="card-title"><%=Noticias.getTitulo()%></h5>
                                        <p><%=Noticias.getDescrip()%></p>
                                    </div>
                                </Form>
                            </div>
                        </div>
